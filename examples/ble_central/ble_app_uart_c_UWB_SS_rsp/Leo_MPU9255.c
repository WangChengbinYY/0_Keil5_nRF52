...
static const nrf_drv_spi_t  SPI_MPU9255 = NRF_DRV_SPI_INSTANCE(configGPIO_SPI_MPU_INSTANCE);  			//MPU9255使用的SPI实例		
/*--------------------------------------------------------------------------*/
...
static uint8_t Leo_SPI_Init()
{
	...
	SPI_config.sck_pin 			= configGPIO_SPI_MPU_SCK;
	SPI_config.mosi_pin 		= configGPIO_SPI_MPU_MOSI;
	SPI_config.miso_pin 		= configGPIO_SPI_MPU_MISO;
	SPI_config.ss_pin			= configGPIO_SPI_MPU_CS;
