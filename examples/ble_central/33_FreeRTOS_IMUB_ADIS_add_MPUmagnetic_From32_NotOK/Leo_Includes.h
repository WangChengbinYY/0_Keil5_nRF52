...
/* SDCard 存储buffer相关 */
#define configSDCard_SaveSize                       2048
#define configSDCard_SaveSector                     5
#define configSDCard_BufferSize                     configSDCard_SaveSize*configSDCard_SaveSector
// 串口接收缓存
...
/* IMU   传感器配置种类 */
#define configIMU_IMUB_ADIS                         0                  //选用单个IMUB的 ADIS
#define configIMU_IMUA_MPU92                        0                  //选用单个IMUA的 MPU9250
#define configIMU_IMUB_ADIS_and_IMUA_MPU92_Magnetic 1                  //IMUB的ADIS为主，外加存储IMUA的MPU9250的磁强计数据

#if ((configIMU_IMUB_ADIS + configIMU_IMUA_MPU92 +configIMU_IMUB_ADIS_and_IMUA_MPU92_Magnetic) != 1)
...
#define configGPIO_INT_IMUA                         10                  //IMU_A 中断
#define configGPIO_INT_IMUB                         9                   //IMU_B 中断
...
/* 响应者  接收错误 Status 标识 用于重置中断标志*/
#define configUWB_RESP_SYSSTATUS_ALL_RX_ERR (SYS_STATUS_RXPHE | SYS_STATUS_RXFCE | SYS_STATUS_RXRFSL | SYS_STATUS_RXSFDTO | SYS_STATUS_AFFREJ | SYS_STATUS_LDEERR)
