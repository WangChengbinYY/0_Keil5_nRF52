...
//    error_code |= nrf_drv_spi_transfer(&SPI_CollectData, tHzLSB,2, tTest,2);	
//    nrf_delay_ms(1);
//    error_code |= nrf_drv_spi_transfer(&SPI_CollectData, tHzMSB,2, tTest,2);	
//    nrf_delay_ms(1);      
