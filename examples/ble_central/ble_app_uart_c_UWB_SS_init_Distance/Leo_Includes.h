...
/* LED___设备LED显示管脚设定 ---------------------------*/
#define configGPIO_LED_R                            LED_1               /* 红色LED灯  */
#define configGPIO_LED_G                            LED_2               /* 绿色LED灯  */
...
#define configGPIO_SPI_MPU_SCK				        12				    //连接MPU9255的——>SCL
#define configGPIO_SPI_MPU_MOSI				        11				    //连接MPU9255的——>SDA
#define configGPIO_SPI_MPU_MISO 				    13				    //连接MPU9255的——>ADO  
