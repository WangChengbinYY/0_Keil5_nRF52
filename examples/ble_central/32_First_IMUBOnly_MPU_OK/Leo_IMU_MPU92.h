...
#define MPU9255_SMPLRT_DIV_Rate							(0x04)		//[7:3]:0xxx – 系统数据输出频率设置参数,计算公式：SAMPLE_RATE=Internal_Sample_Rate / (1 + SMPLRT_DIV);
																												//							取0x04，采样1kHz，经过数字低通滤波，输出数据200Hz
...
#define MPU9255_I2C_SLV4_CTRL_MST_DLY					(0x01)		//[4:0]	首先I2C_MST_DELAY_CTRL使能，这些从机仅仅在(1+I2C_MST_DLY)的每个采样点才可工作，
...
#define MPU9255_AK8963_CNTL1_CONTINU_MEASURE2	        (0x06)		//连续测量 模式2    样例中选取的是模式2，说是刷新速率为100Hz
